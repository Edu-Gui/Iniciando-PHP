...
if($idade < 12)
{
    $_SESSION['mensagem-de-sucesso'] ='o participante'. $nome.' com '.$idade.' anos compete na categoria infantil';
    header('location: index.php');
    return;
}
else if($idade >= 13 && $idade <= 18)
{
    $_SESSION['mensagem-de-sucesso'] = 'o participante'. $nome.' com '.$idade.' anos compete na categoria adolescente';
    header('location: index.php');
    return;
}
else
{
    $_SESSION['mensagem-de-sucesso'] ='o participante'. $nome.' com '.$idade.' anos compete na categoria adulto';
    header('location: index.php');
    return;
}
